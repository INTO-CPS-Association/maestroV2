...
import plugins.IODependencyAcyclic;
import plugins.IODependencyCyclic;
import plugins.IODependencyResult;
...
public class IODependencyCalculator {
    ...
    public static IODependencyResult calculateIODependencies(Set<Connection> connections) {
        ...
        java.util.Set<Connection> connectionsJ = scala.collection.JavaConverters.setAsJavaSet(connections);
        ...
        if (cycleCheckResult.cyclic) {
            ...
            java.util.List<ConnectionScalarVariable> ordered = new java.util.ArrayList<ConnectionScalarVariable>();
